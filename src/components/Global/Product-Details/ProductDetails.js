...
import { Box, Button, ClickAwayListener, IconButton, Rating, Typography } from '@mui/material'
                ...
                <Box className={styles.mainContainer}>
                    <Box className={styles.productImagesContainer}>
                        ...
                        <Box className={styles.productImage}>
                            <Button onClick={() => handleImg(image1)} className={`${styles.productImageBtn} ${activeImg === image1 && styles.productActiveImg}`}>
                                <Image
                                    src={image1}
                                    alt={name}
                                    width={60}
                            ...
                            <Button onClick={() => handleImg(image2)} className={`${styles.productImageBtn} ${activeImg === image2 && styles.productActiveImg}`}>
                                <Image
                                    src={image2}
                                    alt={name}
                                    width={60}
                    ...
                    <Box className={styles.productBottomPart}>
                        <Box className={styles.productDetails}>
                            ...
                            <Typography variant='subtitle1' className={styles.productBrand}>
                                Brand: {brand}
                            </Typography>
                            <Typography variant='subtitle1' className={styles.productSeller}>
                                Seller: {seller}
                            </Typography>
                        
                            <Box className={styles.productRatingContainer}>
                                <Typography variant='subtitle1' className={styles.productRate}>
                                    Rated:
                                </Typography>
                        ...
                        :
                        <Button onClick={() => handleAddToCart(id, name, price, image1, discount)} className={styles.productButton}>
                            Add To Cart
                        </Button>
                        }
                    </Box>
