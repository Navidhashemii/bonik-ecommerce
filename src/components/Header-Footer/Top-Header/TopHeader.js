...
function TopHeader() { 
  ...
  return (
        <Box bgcolor="headerFooter.main" className={styles.MainContainer}>
          <Box className={styles.MainInnerContainer}>
            ...
            <Box className={styles.contactContainer}>
              <Button variant="text" startIcon={<PhoneIcon />} className={styles.phoneContact}>
                +989134402027
              </Button>
              <Button variant="text" startIcon={<EmailIcon />} className={styles.emailContact}>
