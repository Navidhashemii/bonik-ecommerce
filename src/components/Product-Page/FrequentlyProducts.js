        ...
        <Box className={styles.frqContainer}>
            ...
            return (
                <Grid
                    ...
                    md={3}
                >
                    <Box className={styles.frqCardContainer}>
                        <Box className={styles.frqCard}>
                            <Image
                                ...
                                priority
                            />
                            <Divider className={styles.frqDivider} />
                            <Typography
                                variant='h6' 
                                className={styles.frqName}
                            >
                                {name}
                            </Typography>
                                ...
                                <Typography 
                                    variant='h6' 
                                    color='secondary' 
                                    className={styles.frqAfterDiscount}
                                >
            ...
            <Box className={styles.frqSumupContainer}>
                ...
                <>
                    ...
                    <Typography 
                        variant='subtitle1' 
                        className={styles.frqDiscount}
                    >
                        Save ${discount.toFixed(2)}
                    </Typography>

                    <Button 
                        onClick={() => handleAddToCart(randomizedItems.current)} 
                        className={styles.frqBtn}
                    >
                        Add To Cart
                    </Button>
                </>
